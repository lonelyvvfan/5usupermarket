...
public class PageModel {
     ...
     * @return 总页数
     */
    public static Integer countTotalPage(final Integer pageSize,final Integer allRow){
     ...
     * @return 当前页开始记录号
     */
    public static Integer countBeginset(final Integer pageSize,final Integer currentPage){
        final Integer beginset = pageSize*(currentPage-1);
        return beginset;
    }
    ...
    public static Integer countCurrentPage(Integer page){
        final Integer curPage = (page==0?1:page);
        return curPage;
    }
}
