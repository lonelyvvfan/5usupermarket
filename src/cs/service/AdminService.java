...
/*+++++++++++++alter开始++++++++++++++*/
	 ...
	 * 修改套餐信息
	 */
	public List<Combo> altercombo(Integer id,  String goodsname, String introduce,double price, double nowprice, 
			String savepath, String savepath1, String savepath2,String savepath3, String shelves,Integer monthsell , Integer zan , String reason , Integer inventory);
	 ...
	 */
	 public List<Secondgoods> altersecgoods(Integer id,Integer userid,String username,String nickname, Integer suptypeid,
				...
				double price, double nowprice, String savepath,String savepath1, String savepath2,String savepath3, Integer newgoods,
				Integer hot, Integer special, Integer health, Integer recommend , String shelves, String qq , String telephone ,  String other ,
				String reason, Integer recency, String school,String living);
