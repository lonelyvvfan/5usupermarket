		...
		<div id="all">
			<form method="post" action = "admin/adminshowSeller!deletecheckbox">
				<table class="m_table"  border="0" cellspacing="0" cellpadding="0"
					...
					<thead>
					<tr>
					<td><input class="btn btn-danger all_option" name="delcheck" id="bt1" type="submit" value="删除"  onmousedown="delAll_confirm()"   /></td>
<!-- 					<td><input class="btn btn-update all_option" type="submit" value="修改" /></td> -->
					...
					<tbody>
						<s:iterator value="sellerpage.list">
							...
							<tr>	
								<td>
									<a href="admin/adminshowSeller?sellerpage.currentPage=1">首页</a>
								</td>
								<s:iterator value="sellerpage.pageList" id="e">
									<td>
										<a href="admin/adminshowSeller?sellerpage.currentPage=${e}">${e}</a>
									</td>
								</s:iterator>
							<td>
								<a href="admin/adminshowSeller?sellerpage.currentPage=${sellerpage.totalPage}">末页</a>
							</td>	
							<td>共有${sellerpage.totalPage}页，${sellerpage.allRow}条记录
							</td>
						</tr>
