...
<div id="win">
		...
		<div id="right">
			...
			<div id="form">
				<form action="admin/adminshowCombo!altercombo"  method="post"
					...
					<table class="table">
						...
						<tr>
							<td>库存：</td>
							<td>
								<input class="t_text"  type="text" name="inventory" value="${combo.inventory}"  required/>
							</td>
						</tr>
						<tr>
							<td>推荐理由：</td>
							<td>
								<input class="t_text"  type="text" name="reason" value="${combo.reason}"  maxlength="9"  required/>可输入九个字符
							</td>
						</tr>
						<tr>
							<td>原价：</td>
					...
					<tr>
						<td>当前商品其他图片1：</td>
						<td><img alt="pic" class="good_img"  src="images/goods${combo.savepath1}">
						</td>
					</tr>
					<tr>
						<td>当前商品其他图片2：</td>
						<td><img alt="pic" class="good_img"  src="images/goods${combo.savepath2}">
						</td>
					</tr>
					<tr>
						<td>当前商品其他图片3：</td>
						<td><img alt="pic" class="good_img"  src="images/goods${combo.savepath3}">
						</td>
					</tr>
					<tr>
							<td>商品介绍：</td>
					...
					<tr>
						...
						<td><select id="shelves"  name="shelves"  >
									<option value="${combo.shelves}" >当前选择：<script>selectshelves('${combo.shelves}')</script></option>
		...
		<button class="btn" type="submit" onclick="return confirm('确定修改该套餐信息？')" >修改</button>
		<input type="hidden" name="id" value="${combo.id}"/>
		<input type="hidden" name="savepath" value="${combo.savepath}"/>
		<input type="hidden" name="savepath1" value="${combo.savepath1}"/>
		<input type="hidden" name="savepath2" value="${combo.savepath2}"/>
		<input type="hidden" name="savepath3" value="${combo.savepath3}"/>
	</form>
	</div>
</div>
</div>
