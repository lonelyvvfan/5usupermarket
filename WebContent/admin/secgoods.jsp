...
<body>
	...
	<input	type="submit" class="search_btn" value="查找" />
		...
		<div id="all">
			...
			<tr>	
				<td><a href="admin/adminshowsecGoods?secgoodspage.currentPage=1">首页</a></td>
				<s:iterator value="secgoodspage.pageList" id="e">
					<td><a href="admin/adminshowsecGoods?secgoodspage.currentPage=${e}">${e}</a></td>
				</s:iterator>
				<td><a href="admin/adminshowsecGoods?secgoodspage.currentPage=${secgoodspage.totalPage}">末页</a></td>	
