...
<div id="win">
		...
		<form action="admin/adminshowKeyword!findkeywordspecial" method="post">
			<input type="text" class="search_box" name="title" placeholder="请输入关键字"/> <input
...
<td><input type="checkbox" name="checkbox" ></td>
					...
					<tbody>
						<s:iterator value="page.list">
							...
							<tr>	
								<td>
									<a href="admin/adminshowKeyword?page.currentPage=1">首页</a>
								</td>
								<s:iterator value="page.pageList" id="e">
									<td>
										<a href="admin/adminshowKeyword?page.currentPage=${e}">${e}</a>
									</td>
								</s:iterator>
							<td>
								<a href="admin/adminshowKeyword?page.currentPage=${page.totalPage}">末页</a>
							</td>	
