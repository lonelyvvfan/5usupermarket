...
<div id="win">
	...
	<div id="all">
				...
				<table class="m_table"  border="0" cellspacing="0" cellpadding="0"
					...
					<thead>
					<tr>
					<td><input class="btn btn-danger all_option" type="submit" value="删除"  onmousedown="delAll_confirm()"   /></td>
<!-- 					<td><input class="btn btn-update all_option" type="submit" value="修改" /></td> -->
			...
			<tr>	
				<td><a href="admin/adminshowUser!finduserspecial?userpage.currentPage=1&&username=${username}">首页</a></td>
				<s:iterator value="userpage.pageList" id="e">
					<td><a href="admin/adminshowUser!finduserspecial?userpage.currentPage=${e}&&username=${username}">${e}</a></td>
				</s:iterator>
				<td><a href="admin/adminshowUser!finduserspecial?userpage.currentPage=${userpage.totalPage}&&username=${username}">末页</a></td>	
