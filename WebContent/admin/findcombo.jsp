...
<p id="index3"></p>
	<div id="win">
		...
		<form action = admin/adminshowCombo!findcombospecial = "post">
		<input type="text" class="search_box" name="goodsname" value="${goodsname}" placeholder="请输入套餐名"/>
	<input	type="submit" class="search_btn" value="查找" />
		...
		<form method="post" action = ""  id="myform" name="myform" >
				<table class="m_table"  border="0" cellspacing="0" cellpadding="0"
					...
					<thead>
					<tr>
					<td><input class="btn btn-danger all_option"  name= "bt1"  id= "bt1" type="button" value="删除" onclick="comboupjia('1')"  onmousedown="delAll_confirm()"  /></td>
...
<!-- 					 <td><input class="btn btn-warning all_option" name= "bt3" id= "bt3" type="button" value="下架" onclick="comboupjia('3')"/></td> -->
					...
					-->
					 ...
					 <td><input class="btn btn-info all_option" name= "bt2" id= "bt2" type="button" value="上架" onclick="" onmousedown="upAll_confirm()" /></td>
					 <td><input class="btn btn-warning all_option" name= "bt3" id= "bt3" type="button" value="下架" onclick="" onmousedown="downAll_confirm()" /></td>
					 <td><input class="btn btn-warning all_option" name= "bt4" id= "bt4" type="button" value="仓库" onclick=""/></td>
					</tr>
						<tr
			...
			<tr>	
				<td><a href="admin/adminshowCombo!findcombospecial?combopage.currentPage=1&&goodsname=${goodsname}">首页</a></td>
				<s:iterator value="combopage.pageList" id="e">
					<td><a href="admin/adminshowCombo!findcombospecial?combopage.currentPage=${e}&&goodsname=${goodsname}">${e}</a></td>
				</s:iterator>
				<td><a href="admin/adminshowCombo!findcombospecial?combopage.currentPage=${combopage.totalPage}&&goodsname=${goodsname}">末页</a></td>	
