...
<div id="win">
		...
		<form action="admin/adminshowHelpcenter!findhelpspecial" method="post">
			<input type="text" class="search_box" name="title" value="${title}" placeholder="请输入标题"/> <input
...
<!-- 									</form> -->
						...
						<tr>
						<td><a href="admin/adminshowHelpcenter!findhelpspecial?page.currentPage=1&&title=${title}">首页</a></td>
				<s:iterator value="page.pageList" id="e">
					<td><a href="admin/adminshowHelpcenter!findhelpspecial?page.currentPage=${e}&&title=${title}">${e}</a></td>
				</s:iterator>
				<td><a href="admin/adminshowHelpcenter!findhelpspecial?page.currentPage=${page.totalPage}&&title=${title}">末页</a></td>	
