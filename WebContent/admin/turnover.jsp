...
<div id="win">
		...
		<form action="admin/adminshowOrder!turnover" method="post">
			订单开始日期：<input type="text" class="search_box" name="startdate" onclick="new Calendar().show(this);"  readonly="readonly" placeholder="请选择订单起始日期" />
			—订单截止时间：<input type="text" class="search_box" name="enddate" onclick="new Calendar().show(this);"  readonly="readonly" placeholder="请选择订单截止日期" /> 
