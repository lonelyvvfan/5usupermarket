...
<div id="win">
		...
		<div id="right">
			...
			<div id="form">
		<form action="admin/adminshowTakeout!addtakeout" method="post"
enctype="multipart/form-data">
		...
		<option value="1">全部</option>
						...
						<tr>
							<td>现价：</td>
							<td><input class="t_text"  type="text" name="nowprice"/>元
							</td>
						</tr>
						<tr>
						<td>商品主图片：</td>
		...
		<input   type="hidden" name="sellername" value="${username}"/>
		 <button class="btn" type="submit" onclick="return confirm('确定添加该外卖商品？')" >添加</button>
	</form>
	</div>
</div>
</div>
