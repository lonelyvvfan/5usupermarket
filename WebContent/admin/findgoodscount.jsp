...
<body>
	...
	<div id="win">
		...
		<form action="admin/adminshowOrder!goodscount" method="post">
			商品名：<input type="text" class="search_box" name="goodsname" value="${goodsname}" required placeholder="请输入商品名" />
		...
		<form method="post" action = ""  id="myform" name="myform" >
				<table class="m_table goodscount"  border="0" cellspacing="0" cellpadding="0"
					class="table table-hover" style="margin-top:20px">
					<thead>
					<tr>
					...
					<tbody>
						<s:iterator value="goodscountpage">
							<tr>
								<td>${goodsname}</td>
								<td>${number}</td>
								<td>${total}元</td>
				...
				<tr>
					<td><b>共有 &nbsp;${goodscountpage.size()} &nbsp;条记录</b></td>
				</tr>
	</div>
	</div>
</div>
