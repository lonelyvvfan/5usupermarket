...
<div id="win">
		...
		<div id="right">
			...
			<div id="form">
		<form action="admin/adminshowHelpcenter!addhelp" method="post"
enctype="multipart/form-data">
			...
			<table class="table">
						...
						<tr>
							<td>内容：</td>
							<td><textarea id="editor_1" rows="40" cols="40" name="content" ></textarea>
							<p id="count">您当前输入了 <span class="word_count2">0</span> 个文字。<span class="word_surplus"></span></p>
						</td>
					  </tr>
		</table>
		 <button class="btn" type="submit" onclick="return confirm('确定添加该帮助信息？')" >添加</button>
	</form>
	</div>
</div>
</div>
