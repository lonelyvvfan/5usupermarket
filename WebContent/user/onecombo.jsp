...
<p id="index1"></p>
 <p id="left"><img src="image/weixin1.png"/></p>
    ...
    <div id="information">
        ...
        <ul>
            <li><img src="images/goods${combo.savepath}"  onmouseover="good_show(this)" onerror="javascript:this.src='image/error.jpg'"></li>
            <li><img src="images/goods${combo.savepath1}"  onmouseover="good_show(this)" onerror="javascript:this.src='image/error.jpg'"></li>
            <li><img src="images/goods${combo.savepath2}"  onmouseover="good_show(this)" onerror="javascript:this.src='image/error.jpg'"></li>
            <li><img src="images/goods${combo.savepath3}"  onmouseover="good_show(this)" onerror="javascript:this.src='image/error.jpg'"></li>
        </ul>
        </div>
        <div id="main_information">
            ...
            <div class="box_inf">
            <div class="in1 zan">
                    <form action = "user/showCombo!dianzan?id=${combo.id}" method="post">
            ...
            <div class="box_inf">
                ...
                <div class="in2">
                    ...
                    <span id="inventory">库存${combo.inventory}</span>
                </div>
            </div>
            <div class="box_inf">
                <div class="in2">
