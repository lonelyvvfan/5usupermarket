...
<p id="index1"></p>
 <p id="left"><img src="image/weixin1.png"/></p>
    ...
    <div id="information">
        ...
        <ul>
              <li><img src="images/goods${goods.savepath}"  onmouseover="good_show(this)" onerror="javascript:this.src='image/error.jpg'"></li>
            <li><img src="images/goods${goods.savepath1}"  onmouseover="good_show(this)" onerror="javascript:this.src='image/error.jpg'"></li>
            <li><img src="images/goods${goods.savepath2}"  onmouseover="good_show(this)" onerror="javascript:this.src='image/error.jpg'"></li>
            <li><img src="images/goods${goods.savepath3}"  onmouseover="good_show(this)" onerror="javascript:this.src='image/error.jpg'"></li>
        </ul>
        </div>
