		...
		function nOver(m,i,n)
		{
        	...
        	if (j>6){
          	...
          	$('#p'+m).append('</tr>');
			$.ajax({
		        url: 'test?currentPage='+i+'&&suptypeid='+m+'&&subtypeid='+n,
		        type: 'get',
		        dataType: 'json',
		        error: function(){
		        },
