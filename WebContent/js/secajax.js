			...
			$.ajax({
		        ...
		        success: function(responseResult){
		        	 $(responseResult.list).each(function(){
			            	$('#q2').append('<li><a href='+'"showSecgoods?id='+this.id+'"'+' target='+"_blank"+'><img src='+'"images/secondgoods/'+this.savepath+'"'+' onerror='+'"'+'javascript:this.src='+"'image/error.jpg'"+'"'+'></a>'+'<p id='+'goodsname'+' title='+'"'+this.goodsname+'"'+'>'+this.goodsname+'</p>'+'<p><b class='+'"price"'+'>&#65509;'+this.price+'</b></p><h3>'+this.reason+'</h3></li></a>');
				        });
		        }
		    });
			    $.ajax({
			        ...
			        success: function(responseResult){
			        	$(responseResult.list).each(function(){
			            	$('#q3').append('<li><a href='+'"showSecgoods?id='+this.id+'"'+' target='+"_blank"+'><img src='+'"images/secondgoods/'+this.savepath+'"'+' onerror='+'"'+'javascript:this.src='+"'image/error.jpg'"+'"'+'></a>'+'<p id='+'goodsname'+' title='+'"'+this.goodsname+'"'+'>'+this.goodsname+'</p>'+'<p><b class='+'"price"'+'>&#65509;'+this.price+'</b></p><h3>'+this.reason+'</h3></li></a>');
				        });
			        }
			    });
			    $.ajax({
			        ...
			        success: function(responseResult){
			        	$(responseResult.list).each(function(){
			            	$('#q4').append('<li><a href='+'"showSecgoods?id='+this.id+'"'+' target='+"_blank"+'><img src='+'"images/secondgoods/'+this.savepath+'"'+' onerror='+'"'+'javascript:this.src='+"'image/error.jpg'"+'"'+'></a>'+'<p id='+'goodsname'+' title='+'"'+this.goodsname+'"'+'>'+this.goodsname+'</p>'+'<p><b class='+'"price"'+'>&#65509;'+this.price+'</b></p><h3>'+this.reason+'</h3></li></a>');
				        });
			        }
			    });
			    $.ajax({
			        ...
			        success: function(responseResult){
			        	$(responseResult.list).each(function(){
			            	$('#q5').append('<li><a href='+'"showSecgoods?id='+this.id+'"'+' target='+"_blank"+'><img src='+'"images/secondgoods/'+this.savepath+'"'+' onerror='+'"'+'javascript:this.src='+"'image/error.jpg'"+'"'+'></a>'+'<p id='+'goodsname'+' title='+'"'+this.goodsname+'"'+'>'+this.goodsname+'</p>'+'<p><b class='+'"price"'+'>&#65509;'+this.price+'</b></p><h3>'+this.reason+'</h3></li></a>');
				        });
			        }
			    });
			    $.ajax({
			        ...
			        success: function(responseResult){
			        	$(responseResult.list).each(function(){
			            	$('#q6').append('<li><a href='+'"showSecgoods?id='+this.id+'"'+' target='+"_blank"+'><img src='+'"images/secondgoods/'+this.savepath+'"'+' onerror='+'"'+'javascript:this.src='+"'image/error.jpg'"+'"'+'></a>'+'<p id='+'goodsname'+' title='+'"'+this.goodsname+'"'+'>'+this.goodsname+'</p>'+'<p><b class='+'"price"'+'>&#65509;'+this.price+'</b></p><h3>'+this.reason+'</h3></li></a>');
				        });
			        }
			    });
			});		
	...
	$.ajax({
	 ...
	 $.ajax({
	        ...
	        success: function(responseResult){
	        	...
	        	$(responseResult.list).each(function(){
	            	$('#q'+n).append('<li><a href='+'"showSecgoods?id='+this.id+'"'+' target='+"_blank"+'><img src='+'"images/secondgoods/'+this.savepath+'"'+' onerror='+'"'+'javascript:this.src='+"'image/error.jpg'"+'"'+'></a>'+'<p id='+'goodsname'+' title='+'"'+this.goodsname+'"'+'>'+this.goodsname+'</p>'+'<p><b class='+'"price"'+'>&#65509;'+this.price+'</b></p><h3>'+this.reason+'</h3></li></a>');
		        });
...
function choose(m,n)
{
	...
	$.ajax({
        ...
        success: function(responseResult){
        	...
        	$(responseResult.list).each(function(){
            	$('#q'+m).append('<li><a href='+'"showSecgoods?id='+this.id+'"'+' target='+"_blank"+'><img src='+'"images/secondgoods/'+this.savepath+'"'+' onerror='+'"'+'javascript:this.src='+"'image/error.jpg'"+'"'+'></a>'+'<p id='+'goodsname'+' title='+'"'+this.goodsname+'"'+'>'+this.goodsname+'</p>'+'<p><b class='+'"price"'+'>&#65509;'+this.price+'</b></p><h3>'+this.reason+'</h3></li></a>');
	        });
        }
    });	
}
