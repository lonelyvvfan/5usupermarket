...
<head>
	<script language="javascript" src="js/jquery-1.7.2.min.js"></script>
	 ...
	 <script type="text/javascript" src="js/cnmajax.js"></script>
...
<div class="sort" onmouseover="right_active1('l1')">
    <h2 id="t1" style="border-color: cornflowerblue">
        <span style="color: cornflowerblue">早餐</span>
...
<div class="sort" onmouseover="right_active1('l2')">
    <h2 id="t2" style="border-color: #e99b0f">
        <span style="color: #e99b0f">中餐</span>
...
<div class="sort" onmouseover="right_active1('l3')">
    <h2 id="t3" style="border-color: #99c94d">
        <span style="color: #99c94d">晚饭</span>
