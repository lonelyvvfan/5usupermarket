...
<div id="s_win">
		...
		<div id="s_right">
			...
			<div id="s_form">
		<form action="showSecgoods!add"  method="post"
enctype="multipart/form-data">
			...
			<table class="table table-striped table-hover table-bordered " >
						<tr>
							...
							<td>
								<input type="text" class="s_t_text" name="nickname" value="${nickname}" required >
							</td>
						</tr>
						<tr>
		...
		<option value="1">全部</option>
						...
						<td>
						<input type="radio" tabindex="17" name="new" class="no_new" id="no_new" checked>非全新</input>
						...
						<tr>
							...
							<td><input class="s_t_text"  type="text" name="price" onkeyup="checkNum(this)"  />元
							</td>
						</tr>
						<tr>
							<td class="for"><img src="image/sec_write.png"/>推荐理由：</td>
							<td><input class="s_t_text"  type="text" name="reason" maxlength="9" required/>
							</td>
						</tr>
						<tr>
					  ...
					  <tr>
						...
						<tr>
							<td class="for"><img src="image/meg_email.png" required />QQ：</td>
							<td>
								<input class="s_t_text" type="text" name="qq"/>
							</td>
						</tr>
						<tr>
							<td class="for"><img src="image/meg_pho.png"/>手机号：</td>
							<td>
								<input class="s_t_text"  type="text" name="telephone" required/>
							</td>
						</tr>
					  ...
					  <tr>
							...
							<td><textarea id="s_editor_1" rows="40" cols="40" name="introduce" onkeyup="this.value = this.value.substring(0, 80)" >
							</textarea>
