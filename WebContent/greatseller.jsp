...
<head>
	<script language="javascript" src="js/jquery-1.7.2.min.js"></script>
	 ...
	 <script type="text/javascript" src="js/greatajax.js"></script>
...
<div class="sort" onmouseover="right_active1('l1')">
    <h2 id="1F" style="border-color: #5dc3e4">
        <span style="color: #5dc3e4">女装/内衣</span>
...
<div class="sort" onmouseover="right_active1('l2')">
    <h2 id="2F" style="border-color: #f4b217">
        <span style="color:#f4b217">男/运动户外</span>
...
<div class="sort" onmouseover="right_active1('l3')">
    <h2 id="3F" style="border-color: #9ac949">
        <span style="color: #9ac949">男装/内衣</span>
