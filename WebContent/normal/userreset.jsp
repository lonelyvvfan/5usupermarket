...
<form action="userlogin!resetpassword"  method = "post" name="myform" enctype="multipart/form-data" >
        ...
        <button id="find" type="submit" onmousedown="find_able();" >重置</button>
    </form>
