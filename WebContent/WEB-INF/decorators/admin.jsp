...
<![endif]-->
	<div id="header">
		<h1>无忧超市后台管理中心</h1>
		<p class="txt_right">
			欢迎您： <strong>${username}</strong><span class="v_line"> | </span>
			<a href="admin/login!logout"><strong>登出</strong><span class="v_line"> | </span></a>
			<a href="admin/alteradmin.jsp"><strong>修改密码</strong></a>
		</p>
	</div>
	<div id="menu">
		<ul>
			<li><a href="admin/adminshowOrder">订单管理</a></li>
			<li><a href="admin/adminshowGoods">超市管理</a></li>
			<li><a href="admin/adminshowCombo">套餐管理</a></li>
			<li><a href="admin/adminshowsecGoods">二手商品管理</a></li>
			<li><a href="admin/adminshowTakeout">外卖管理</a></li>
			<li><a href="admin/adminshowGreatseller">推荐商家管理</a></li>
			<li><a href="admin/adminshowUser">用户管理</a></li>
			<li><a href="admin/adminshowSeller">外卖商家管理</a></li>
			<li><a href="admin/adminshowHelpcenter">帮助中心</a></li>
			<li><a href="admin/adminshowKeyword">热门搜索词</a></li>
			<li><a href="admin/adminshowNotice">公告</a></li>
			<li><a onmouseover="allcount.style.visibility='visible'" onmouseout="out()">统计</a>
			<ul id="allcount"  onmouseover="this.style.visibility='visible'" onmouseout="this.style.visibility='hidden'">
				<li><a id="goodscount" href="admin/goodscount.jsp">商品营业额</a></li>
				<li><a id="turnover"  href="admin/turnover.jsp">总营业额</a></li>
			</ul>
			</li>
		</ul>
	</div>
...
<script type="text/javascript">
    $(function () {
        ...
        dv.attr('menu', dv.offset().top); //存储原来的距离顶部的距离
        $(window).scroll(function () {
            st = Math.max(document.body.scrollTop || document.documentElement.scrollTop);
            if (st > parseInt(dv.attr('menu'))) {
            ...
            } else if (dv.css('position') != 'static') dv.css({ 'position': 'static','width':'1190px' });
        });
    });
    
    function out(){
    	var count=document.getElementById("count");
        if(window.event.toElement.id!="count"&&window.event.toElement.id!="goodscount"&&window.event.toElement.id!="turnover")
           allcount.style.visibility="hidden";
    }
</script>
</html>