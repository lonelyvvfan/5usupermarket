...
<div id="forcar"></div>
<div id="top">
    <span id="top_name"><script>selectschool('${school}')</script>[<a href="normal/school.jsp" style="color: red;text-decoration: none;">切换学校</a>] </span>
    ...
    <p id="top_message" onmouseout="log()">
        <a href="normal/userlogin.jsp" onmouseover="login.style.visibility='visible'" class="m1"> 登陆</a>
        <a href="normal/register.jsp" class="m1 m2" >注册</a>
        <div id="login" style="visibility:hidden;"  onmouseover="this.style.visibility='visible'" onmouseout="this.style.visibility='hidden'" >
        <a id="l_link" onmouseover="this.style.color='white';this.style.background='#f4b217'" onmouseout="this.style.color='#e99517';this.style.background=''" href="normal/userlogin.jsp" ><img id="l_weibo" src="image/5u.png"/>无忧登陆</a>
        <a id="l_link" onmouseover="this.style.color='white';this.style.background='#f4b217'" onmouseout="this.style.color='#e99517';this.style.background=''" href="#" ><img id="l_weibo" src="image/succese_weibo.png"/>微博登陆</a>
        <a id="l_link" onmouseover="this.style.color='white';this.style.background='#f4b217'" onmouseout="this.style.color='#e99517';this.style.background=''"  href="#"><img id="l_qq" src="image/success_qq.png"/>QQ登陆</a>
        <a  id="l_link" onmouseover="this.style.color='white';this.style.background='#f4b217'" onmouseout="this.style.color='#e99517';this.style.background=''"  href="#"><img id="l_renren" src="image/success_renren.png"/>人人登陆</a>
    </div>
    </p>
...
<div id="head">
    <a href="goods.jsp" id="logo"><img src="image/logo.png"/></a>
    <div id="main">
        <div class="search">
...
<div id="container">
    ...
    <a  id="contact" href="tencent://message/?uin=2497537771&Site=www.5uchaoshi.com.cn&Menu=yes"><img   src="image/contect.png"></a>
        <p id="for">生活无忧</p>
        <ul id="c_top_term">
            <li style="border-bottom-color: red"><a href="goods.jsp"  onmouseover="this.style.backgroundColor='red'" onmouseout="this.style.backgroundColor=''"> 校园超市</a></li>
            <li style="border-bottom-color: palevioletred"><a href="secondgoods.jsp"  onmouseover="this.style.backgroundColor='palevioletred'" onmouseout="this.style.backgroundColor=''"> 跳蚤市场</a></li>
            <li style="border-bottom-color: plum"><a href="takeout.jsp" onmouseover="this.style.backgroundColor='plum'" onmouseout="this.style.backgroundColor=''"> 外卖专区</a></li>
            <li style="border-bottom-color: greenyellow"><a  href="greatseller.jsp" onmouseover="this.style.backgroundColor='greenyellow'" onmouseout="this.style.backgroundColor=''"> 推荐商家</a></li>
        </ul>
        <a  href="addsecgoods.jsp" id="two" target="_blank" class="set_green" onmouseover="ctwo()" onmouseout="rtwo()">免费卖二手</a>
        <ul id="pho">
...
<div id="footer">
    ...
    <div id="foot_d">
    <ul class="foot_list">
        <li><a href="showHelp!view?id=2" target="_blank">配送时间/范围</a> </li>
        <li><a href="showHelp!view?id=6" target="_blank">网站免责声明</a> </li>
    </ul>
    <ul class="foot_list">
        <li><a href="showHelp!view?id=7" target="_blank">购物流程</a> </li>
        <li><a href="showHelp!view?id=8" target="_blank">支付方式</a> </li>
    </ul>
    <ul class="foot_list">
        <li><a href="showHelp!view?id=9" target="_blank">招贤纳士</a> </li>
        <li><a href="showHelp!view?id=10" target="_blank">业务合作</a> </li>
    </ul>
    <ul class="foot_list">
        <li><a href="showHelp!view?id=11" target="_blank">关于我们</a> </li>
        <li><a href="showHelp!view?id=12" target="_blank">消费者保障</a> </li>
    </ul>
    <ul class="foot_list">
        <li><a href="showHelp!view?id=16" target="_blank">商家须知</a> </li>
